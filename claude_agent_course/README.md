...
本课程旨在通过**循序渐进 (Step-by-Step)** 的方式，带领开发者从零掌握 Claude Agent SDK。

## 目录结构

### 📅 Phase 1: 觉醒 (Awakening) - 基础与原理
*   **[Module 1: Agent 思维导论](./module_01_foundations/)**
    *   理解 Agent 本质，搭建开发环境。
*   **[Module 2: 赋予双手 - 基础工具](./module_02_core_tools/)**
    *   掌握 FileSystem 和 Bash 工具，让 Agent 操作电脑。
